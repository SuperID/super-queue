...
class Consumer extends EventEmitter {
  ...
  constructor(options) {
    ...
    const heartbeat = () => {
      ...
      const key = utils.getHeartbeatKey(this._redisPrefix, 'consumer', this.name);
      // msg: name,startedAt,msgTotal,msgSuccess,msgError,msgExpired,capacity,processingCount
      const info = `${this.name},${this._startedAt},${this._msgCounterTotal},${this._msgCounterSuccess},${this._msgCounterError},${this._msgCounterExpired},${this.capacity},${this._processing.size}`;
