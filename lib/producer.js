...
class Producer extends EventEmitter {
  ...
  constructor(options) {
    ...
    const heartbeat = () => {
      ...
      const key = utils.getHeartbeatKey(this._redisPrefix, 'producer', this.name);
      // msg: name,startedAt,msgTotal,msgSuccess,msgError,msgExpired
      const info = `${this.name},${this._startedAt},${this._msgCounterTotal},${this._msgCounterSuccess},${this._msgCounterError},${this._msgCounterExpired}`;
